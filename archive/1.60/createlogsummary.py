...
AFconfig=[ 'getInfo_c1', 'getInfo_c2', '100r0w_long_af_c1', '100r0w_long_af_c2', '70r30w_long_mdCap_af_c1', '70r30w_long_mdCap_af_c2', 'short_io_c1', '70r30w_long_mdCap_enc_af_c1', 
           ...
           'data_integrity_af_c1', 'data_integrity_af_c2', 'af_diskRemoveReinsertPlanned', 'af_diskRemoveReinsertUnplanned' ]   
...
HYconfig=[ 'getInfo_c1', 'getInfo_c2', '30r70w_short', '0r100w_short', '100r0w_short', '50r50w_short', '90r10w_short', '70r30w_short', '10r90w_short', 
           ...
           '70r30w_long_99phr_enc_c1', '70r30w_long_99phr_enc_c2', 'diskRemoveReinsertPlanned', 'diskRemoveReinsertUnplanned' ]
...
def TestSanityCheck(sr, iocertver):
    ...
    if float(iocertver) >= 4.035:
    ...
    elif float(iocertver) >= 2.030 and float(iocertver) <= 2.048:
        ...
        if float(iocertver) == 2.035:
            tmpHY = 'reset_c1'
            HYconfig.remove(tmpHY)
            tmpHY = 'reset_c2'
            HYconfig.remove(tmpHY)

            HYconfig.append('reset')
...
def writeSummaryToHTML(summary):
    ...
    # populate any missing tests, missing test will be in red color
    for i in missingTest:
        html_str6 = """
        <td style="color:#DC143C" bgcolor="#CCCCFF">""" + i + """</td>        
                """
...
def genLogsummary(currentPath, testname, ts, output):
    ...
    pattern = re.compile(r'summary-ctrlr_|summary-ctrlr-|.txt|_RAID1')
