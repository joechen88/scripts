...
AFconfig=['getInfo_c1','getInfo_c2', '100r0w_long_af_c1', '100r0w_long_af_c2', '70r30w_long_mdCap_af_c1', '70r30w_long_mdCap_af_c2', 'short_io_c1',
          'short_io_c2', '10r90w_short', '100r0w_short', '50r50w_short', '0r100w_short', '70r30w_short', '90r10w_short', '30r70w_short',
          '70r30w_long_50gb_af_c1','70r30w_long_50gb_af_c1','70r30w_long_50gb_af_c2', '0r100w_long_4k_af_c1', '0r100w_long_4k_af_c2', 
          '7day_stress_af_c1', '7day_stress_af_c2', '0r100w_long_64k_af_c1','0r100w_long_64k_af_c2','reset_af_c1','reset_af_c2'
          '70r30w_long_mdCap_enc_af_c1','70r30w_long_mdCap_enc_af_c2','data_integrity_af_c1','data_integrity_af_c2']
...
def TestSanityCheck(sanityresult):
    ...
    if IOCertVER >= 3.018 and IOCertVER <= 3.022:

        #IOcert 3.022 has everything except encryption and data-integrity
        HYconfig.remove('70r30w_long_99phr_enc_c1')
        HYconfig.remove('70r30w_long_99phr_enc_c2')

        AFconfig.remove('70r30w_long_mdCap_enc_af_c1')
        AFconfig.remove('70r30w_long_mdCap_enc_af_c2')
        AFconfig.remove('data_integrity_af_c1')
        AFconfig.remove('data_integrity_af_c2')
    ...
    if IOCertVER >= 2.035 and IOCertVER <= 2.048:

        #IOcert 3.022 has everything except encryption, data-integrity, shortIO
        HYconfig.remove('70r30w_long_99phr_enc_c1')
        HYconfig.remove('70r30w_long_99phr_enc_c2')
        HYconfig.remove('short_io_c1')
        HYconfig.remove('short_io_c2')

        AFconfig.remove('70r30w_long_mdCap_enc_af_c1')
        AFconfig.remove('70r30w_long_mdCap_enc_af_c2')
        AFconfig.remove('data_integrity_af_c1')
        AFconfig.remove('data_integrity_af_c2')
        AFconfig.remove('short_io_c1')
        AFconfig.remove('short_io_c2')
...
def writeSummaryToHTML(summary):
	...
	#
        ...
        #read testVPXstatus ; if COMPLETED then add testname + ver into sanityResult variable for test Sanity Checking
