...
###############################################################################
#
# Log summary for hotplug SSDRemoveReinsertUnplanned test
#
# Functions:
#   Collect a summary for SSDRemoveReinsertUnplanned test.
#
###############################################################################
...
if [[ -n "$filename" ]]; then
  ...
  echo ""
  echo "                                    ==============================================="
  echo "                                        ${green} SSDRemoveReinsertUnplanned test ${nc}"
  echo "                                    ==============================================="
  echo ""
  echo ""
  ...
  echo ""
  echo "	Usage: hotplug-SSDRemoveReinsertUnplanned.sh <filename>"
  echo ""
  echo "               example: sh hotplug-SSDRemoveReinsertUnplanned.sh test-vpx.vsan.fvt.test.lsom.diskmanagement.SSDRemoveReinsertUnplanned_RAID1.log"
  echo ""
fi
