...
def GetInfo(testName,hostName):
	...
	tmpDN=sorted(set(DisplayName))

	if len(deviceQueueDepth) > 0:
		for j in range(0,len(tmpDN)):
			if len(tmpDN) > 0:
