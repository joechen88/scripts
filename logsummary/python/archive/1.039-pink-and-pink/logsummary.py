...
def GetInfo(testName,hostName):
	...
	print "=Firmware / Firmware package="
	print "Firmware Version: ", 
	print firmware

	print "Firmware Package Version: ",
	print firmwarePackage
	print "\n\n\n"
...
def displaySummary(testName,hostName,test,testVer,deployVMtime,allVMDeployedtime,complete,hpComplete):
# display Summary
...
def collectLogs(filename, testName):
	...
	global firmware, firmwarePackage
	global deviceQueueDepth, DisplayName, DriveSize, DriveModel
	global diskResult, Name, vsanUUID, State, isSSD, bootbank
...
# read through the test-vpx file and collect data
	...
	for line in readFile:
		...
		if re.match ("(.*)Firmware Package Version", line):
			firmwarePackage = line
...
#			elif re.match(r'^}$', line):
	...
	if testName == "getinfo":
		...
		displaySummary(testName,hostName,test,testVer,deployVMtime,allVMDeployedtime,complete,hpComplete)
