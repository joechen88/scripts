...
###############################################################################
#
# Log summary for af-90r10w short
#
# Functions:
...
if [[ -n "$filename" ]]; then
  ...
  echo ""
  echo "                                    ===========================================" 
  echo "                                          90r10w short test (50mins max)"
  echo "                                    ==========================================="
  echo ""
  echo ""
  ...
  EndTimeIOBlazerOrFIO="$(cat $filename | grep -iE 'vsan.iocert.ctrl_90r10w_short...............................COMPLETED' | sed '1,1!d' | cut -d, -f1)"
  echo ""
  ...
  echo ""
  echo "	Usage: af-90r10w_short.sh <filename>"
  echo ""
  echo "               example: sh af-90r10w_short.sh test-vpx.vsan.iocert.ctrl_90r10w_short.log"
  echo ""
fi
