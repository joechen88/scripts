...
if [ "$filename" == "test-vpx.vsan.iocert.ctrlr_0r100w_long_4k_af_c1.log" ] || [ "$filename" == "test-vpx.vsan.iocert.ctrlr_0r100w_long_4k_af_c2.log" ]; then
  ...
  cat test-vpx.log | grep -iE "Starting test vsan.iocert.ctrlr_0r100w_long_4k_af_|vsan.iocert.ctrlr_0r100w_long_4k_af_c1......................COMPLETED|vsan.iocert.ctrlr_0r100w_long_4k_af_c2......................COMPLETED"
  echo ""
  echo ""
