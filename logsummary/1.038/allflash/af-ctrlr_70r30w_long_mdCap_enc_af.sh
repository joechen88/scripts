...
###############################################################################
#
# Log summary for af-70r30w_long_mdCap_enc.sh
#
# Functions:
#   Collect a summary for 70r30w_long_mdCap_enc.sh test.
#
###############################################################################
...
if [ "$filename" == "test-vpx.vsan.iocert.ctrlr_70r30w_long_mdCap_enc_af_c1.log" ] || [ "$filename" == "test-vpx.vsan.iocert.ctrlr_70r30w_long_mdCap_enc_af_c2.log" ]; then


  echo ""
  echo "                                    ================================================================="
  echo "                                                AF 70r30w_long_mdCap_enc.sh test (10hrs max)"
  echo "                                    ================================================================="
  echo ""
  echo ""
  ...
  # 70r30w long mdCap encryption test
  echo "=70r30w long mdCap encryption test (4 hrs)="
  cat $filename | grep -iE "Starting test vsan.iocert.ctrlr_70r30w_long_mdCap_enc_af|vsan.iocert.ctrlr_70r30w_long_mdCap_enc_af_c1...............COMPLETED|vsan.iocert.ctrlr_70r30w_long_mdCap_enc_af_c2...............COMPLETED"
  echo ""
  echo ""
  ...
  # status
  echo "=Status="
  cat $filename | grep -iE 'vsan.iocert.ctrlr_70r30w_long_mdCap_enc_af_c1...............COMPLETED|vsan.iocert.ctrlr_70r30w_long_mdCap_enc_af_c2...............COMPLETED'
  echo ""
  echo ""  

else
  echo ""
  echo "  Usage: af-70r30w_long_mdCap_enc.sh <filename>"
  echo ""
  echo "               example: sh af-70r30w_long_mdCap_enc.sh test-vpx.vsan.iocert.ctrlr_70r30w_long_mdCap_enc_af_c1.log"
  echo ""
fi
