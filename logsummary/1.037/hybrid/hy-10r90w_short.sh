...
###############################################################################
# 
# Log summary for hy-10r90w short
#
# Functions:
...
if [[ -n "$filename" ]]; then
  ...
  echo ""
  echo "                                    ===========================================" 
  echo "                                          10r90w short test (50mins max)"
  echo "                                    ==========================================="
  echo ""
  echo ""
  ...
  EndTimeIOBlazerOrFIO="$(cat $filename | grep -iE 'vsan.iocert.ctrl_10r90w_short...............................COMPLETED' | sed '1,1!d' | cut -d, -f1)"
  echo ""
  ...
  echo ""
  echo "	Usage: hy-10r90w_short.sh <filename>"
  echo ""
  echo "               example: sh hy-10r90w_short.sh test-vpx.vsan.iocert.ctrl_10r90w_short.log"
  echo ""
fi
