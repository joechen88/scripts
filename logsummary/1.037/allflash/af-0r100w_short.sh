...
if [[ -n "$filename" ]]; then
  ...
  echo ""
  echo "                                    ===========================================" 
  echo "                                          0r100w short test (50mins max)"
  echo "                                    ==========================================="
  echo ""
  echo ""
  ...
  EndTimeIOBlazerOrFIO="$(cat $filename | grep -iE 'vsan.iocert.ctrl_0r100w_short...............................COMPLETED' | sed '1,1!d' | cut -d, -f1)"
  echo ""
  ...
  echo ""
  echo "	Usage: af-0r100w.sh <filename>"
  echo ""
  echo "               example: sh af-0r100w.sh test-vpx.vsan.iocert.ctrl_0r100w_short.log"
  echo ""
fi
