...
if [ "$filename" == "test-vpx.vsan.iocert.ctrlr_0r100w_long_64k_af_c1.log" ] || [ "$filename" == "test-vpx.vsan.iocert.ctrlr_0r100w_long_64k_af_c2.log" ]; then
  ...
  echo ""
  echo "                                    ======================================================"
  echo "                                                AF 0r100w_long_64k test (6hrs max)"
  echo "                                    ======================================================"
  echo ""
  echo ""
  ...
  # 100w 64k IO test
  echo "=100w 64K IO test (2 hrs)="
  cat $filename | grep -iE "Starting test vsan.iocert.ctrlr_0r100w_long_64k_af_|vsan.iocert.ctrlr_0r100w_long_64k_af_c1.....................COMPLETED|vsan.iocert.ctrlr_0r100w_long_64k_af_c2.....................COMPLETED"
  echo ""
  echo ""
