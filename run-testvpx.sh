...
#
# ALL_HYBRID_TESTS_H1, ALL_AF_TESTS_H1 = are used to run FULL testing on 1 Host
# ALL_HYBRID_TESTS_H1_H2, ALL_AF_TESTS_H1_H2 = are used to run FULL testing on 2 Hosts
#
ALL_HYBRID_TESTS_H1="vsan/iocert/ctrlr_getInfo_c1.py,vsan/iocert/ctrl_0r100w_short.py,\
vsan/iocert/ctrl_100r0w_short.py,vsan/iocert/ctrl_10r90w_short.py,\
vsan/iocert/ctrl_30r70w_short.py,vsan/iocert/ctrl_50r50w_short.py,\
vsan/iocert/ctrl_70r30w_short.py,vsan/iocert/ctrl_90r10w_short.py,\
vsan/iocert/ctrl_combined_long_c1.py,vsan/iocert/ctrlr_70r30w_long_99phr_enc_c1.py,\
vsan/iocert/ctrlr_reset_c1.py,vsan/iocert/ctrlr_stress_c1.py,vsan/iocert/ctrlr_short_timeout_io_c1.py"

ALL_AF_TESTS_H1="vsan/iocert/ctrlr_getInfo_c1.py,vsan/iocert/ctrl_100r0w_short.py,\
vsan/iocert/ctrl_0r100w_short.py,vsan/iocert/ctrl_10r90w_short.py,vsan/iocert/ctrl_30r70w_short.py,\
vsan/iocert/ctrl_50r50w_short.py,vsan/iocert/ctrl_70r30w_short.py,vsan/iocert/ctrl_90r10w_short.py,\
vsan/iocert/ctrlr_100r0w_long_af_c1.py,vsan/iocert/ctrlr_0r100w_long_4k_af_c1.py,\
vsan/iocert/ctrlr_0r100w_long_64k_af_c1.py,vsan/iocert/ctrlr_70r30w_long_50gb_af_c1.py,\
vsan/iocert/ctrlr_70r30w_long_mdCap_af_c1.py,vsan/iocert/ctrlr_70r30w_long_mdCap_enc_af_c1.py,\
vsan/iocert/ctrlr_reset_af_c1.py,vsan/iocert/ctrlr_data_integrity_af_c1.py,\
vsan/iocert/ctrlr_stress_af_c1.py,vsan/iocert/ctrlr_short_timeout_io_af_c1.py"

ALL_HYBRID_TESTS_H1_H2="Getinfo,All_short_tests,CombineLong,70r30w_long_99phr_enc,Reset-HY,\
ShortIO-HY,Stress-HY"

ALL_AF_TESTS_H1_H2="Getinfo,All_short_tests,100r0w_long_af,0r100w_long_4k_af,0r100w_long_64k_af,\
...
if [ $1 == "Getinfo" ];then
  ...
  TESTNAME="${commonPath}combined_long_c1.py,${commonPath}combined_long_c2.py"
  numOfHost=2
...
if [ ! -z "$TESTVPX" ]; then
    ...
    displayTest "$ALL_AF_TESTS_H1"
    runTest "$ALL_AF_TESTS_H1" "1"
fi
}
...
if [ ! -z "$TESTVPX" ]; then
    ...
    displayTest "$ALL_HYBRID_TESTS_H1"
    runTest "$ALL_HYBRID_TESTS_H1" "1"
fi
}
...
if [ ! -z "$TESTVPX" ]; then
     ...
     displayTest "$ALL_HYBRID_TESTS_H1_H2"
     runTest "$ALL_AF_TESTS_H1_H2" "2"
fi
}
...
if [ ! -z "$TESTVPX" ]; then
     ...
     displayTest "$ALL_HYBRID_TESTS_H1_H2"
     runTest "$ALL_HYBRID_TESTS_H1_H2" "2"
fi
}
